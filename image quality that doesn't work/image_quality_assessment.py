### source: https://github.com/ocampor/notebooks/blob/master/notebooks/image/quality/brisque.ipynb
...
### compute the locally normalized luminances
...
def assess_image_quality(path):
    path = Path("C:/Users/Ethan/Documents/GitHub/Face-and-Keystroke-Authentication/project_data/project_data")
   # images, throwaway = get_images.get_images(path)
   # image = images[0]
   # gray_image = skimage.color.rgb2gray(image)
    # plt.rcParams["figure.figsize"] = 12, 9

    url = 'https://r0k.us/graphics/kodak/kodak/kodim02.png'
